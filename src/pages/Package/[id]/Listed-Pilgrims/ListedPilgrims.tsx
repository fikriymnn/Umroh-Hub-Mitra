...
function Pilgrims() {
      const data = [
    {
      nama: "Anton Budiman",
      gender: "Laki-Laki",
      email: "Antn@gmail.com",
    },
    {
      nama: "Ayah mahmod",
      gender: "Laki-Laki",
      email: "AHmodf@gmail.com",
    },
    {
      nama: "Putrijiwa nanda",
      gender: "Perempuan",
    ...
    },
    {
      nama: "Sumiah Aminah",
      gender: "Perempuan",
      email: "Aminah12@gmail.com",
    },
    {
      nama: "Sumanto",
      gender: "Laki-Laki",
      email: "Kerlan@gmail.com",
    },
    {
      nama: "Jirga Ija",
      gender: "Laki-Laki",
      email: "Ija55@gmail.com",
    },
  ];
  ...
  <div className="w-full px-4 mt-[39px] bg-white shadow-[0px_4px_8.4px_4px] shadow-black/25 rounded-lg">
    <div className="grid grid-cols-5 gap-4 items-start">
        ...
        <div className="flex justify-between">
            <div>
            <h2 className="font-bold text-[#1D1D1D]">Umroh Paket Plus Amanah</h2>
            <p className="text-sm text-gray-500">Paket Plus</p>
            </div>
            <div className="text-right">
            <p className="text-[#1D1D1D] font-semibold">Rp32.000.000</p>
            </div>
            <p className="text-sm text-[#1D1D1D]">87/150</p>
        </div>
                    ...
                    <div className="shadow-black/25 w-full shadow-[0px_4px_15.2px] mt-[32px] ">
                            <table className="w-full border-collapse">
                                ...
                                {data.map((item, i) => (
                                    ...
                                    <td className="p-4 text-[20px]">{item.nama}</td>
                                    <td className="p-4 text-[#696969] text-sm">{item.gender}</td>
                                    <td className="p-4 text-[#696969] text-sm">{item.email}</td>
