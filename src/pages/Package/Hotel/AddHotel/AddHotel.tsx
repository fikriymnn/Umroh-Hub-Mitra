                            ...
                            <div className="w-full grid grid-cols-3 gap-4">
                                ...
                                <div className="">
                                         <div className='flex flex-col space-y-2'>
                                            ...
                                            <select
                                            name="room type"
                                            className="mt-1 w-fit px-2 py-1  text-[14px] rounded-[10px] bg-[#F4F4F4]"
                                            >
                                ...
                                <div className="space-y-1">
                                   ...
                                   <div className="col-span-2 min-h-[300px] h-fit bg-white shadow-[-1px_1px_10.9px] p-6 pt-12 rounded shadow-black/25">
