...
import useDetailHotel from '../../../../hooks/hotel/useDetailHotel'
            ...
            <div className="w-full min-h-screen pb-16">
                ...
                <div className="w-10/12 mx-auto min-h-screen mt-[72px] flex flex-col space-y-4 ">
                    <div className="flex justify-between items-center">
                        ...
                        <p
                            className="text-[#3679FE] font-bold cursor-pointer"
                            onClick={() => navigate(-1)}
                        >
                            Kembali
                        </p>
                    ...
                    <div className="mt-4">
                        <div className="flex space-x-[33px] items-center">
                            <h2 className="text-[24px] font-semibold">{hotel?.hotel_name}</h2>
                            <p>{renderStarsHotels(Number(hotel?.hotel_type))}</p>
                        </div>
                        <div className="flex items-center space-x-2 mt-[19px]">
                            <img src={locationIcon} alt="location icon" className="w-[16px] h-[16px]" />
                            <span className="text-[11px] font-medium">{hotel?.description}</span>
                        </div>
                        <div className="flex items-center space-x-2 mt-[6px]">
                            <img src={roomIcon} alt="room icon" className="w-[16px] h-[16px]" />
                            <span className="text-[11px] font-medium">{hotel?.room_type}</span>
                        </div>
                    </div>
                    <div className="mt-6">
                        ...
                        <div className="flex space-x-10">
                            <div className='ms-[13px]'>
                                ...
                                <ul className="list-disc font-medium ml-[30px] mt-[13px] text-primary-blue space-y-1 text-[15px]">
                                    {hotel?.general_facilities?.map((fgeneral) => (
                            ...
                            <div className='ms-[13px]'>
                                ...
                                <ul className="list-disc font-medium ml-[30px] mt-[13px] text-primary-blue space-y-1 text-[15px]">
                                    {hotel?.hotel_facilities?.map((fhotel) => (
                                        <li>{fhotel?.description}</li>
                                    ))}
                                </ul>
                            </div>
                        </div>
