    ...
    <DefaultLayout>
      ...
      <div className="flex flex-col w-full h-12/12 items-center space-x-[29px] justify-center">
        ...
        <div className="min-w-[160px] h-[160px] mx-auto">
          ...
          <div className=" mt-[30px] h-full w-11/12 shadow-[-5px_2px_14px] shadow-black/25 rounded-xl p-6  grid grid-cols-2 pb-10">
              ...
              <div className="flex flex-col space-y-[20px] border-e-2">
                ...
                <div className="flex justify-center mt-[50px] space-x-5 items-center">
                  ...
                  <div className="w-7/12 h-[170px] grid grid-cols-2">
          ...
          <ResponsiveContainer width="100%" height="100%">
            ...
            <div className="flex flex-col text-sm items-center w-full space-y-1">
                {/* Reguler */}
                      ...
                      <div key={idx} className="w-[100%] flex items-center space-x-2">
                        <span
                          className={`w-[35px] text-right ${
                            isActive ? "font-bold text-[#004492] text-[20px]" : "text-[11px]"
                          }`}
                        >
                          {item.bulan}
                        </span>
                        <div className={`flex items-center px-2  space-x-2 ${isActive ? "shadow-[0px_0px_7.7px] rounded-full shadow-[#1B89FF]" : ""}`}
                          ...
                          />
                        <h1
                          className={` flex items-center w-fit justify-self-end text-[#008FE2]  ${
